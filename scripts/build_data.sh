...
SOURCE_BASE="${SOURCE_BASE:-${R2A_DATASET_ROOT:-${PROJECT_ROOT}/datasets/Reasoning2Action-Sim/dataset_without_depth}}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/outputs/sorting_packages_continuous_v3}"
