...
# ---------------------------------------------------------------------------
# 按本机实际路径修改（默认指向 Dataset 符号链接解析后的 Reasoning2Action-Sim）
# ---------------------------------------------------------------------------
_DATASET_ROOT = Path(os.environ.get("R2A_DATASET_ROOT", "/data/Dataset/Reasoning2Action-Sim/dataset_without_depth"))
...
_BASELINE_PARAMS = os.environ.get(
    "BASELINE_PARAMS",
    "/home/fudan/baseline_code/checkpoints/baseline/30000/params",
)
...
_BASELINE_NORM_ASSETS_DIR = os.environ.get(
    ...
    "/home/fudan/baseline_code/checkpoints/baseline/30000/assets",
)
