...
export FOUR_TASK_REPO_PATHS="${FOUR_TASK_REPO_PATHS:-${DATASET_ROOT}/pour_workpiece:${DATASET_ROOT}/open_door:${DATASET_ROOT}/take_wrong_item_shelf:${DATASET_ROOT}/scoop_popcorn:${DATASET_ROOT}/scoop_popcorn_part_2:${DATASET_ROOT}/hold_pot}"
