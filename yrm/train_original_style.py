...
def _build_config(
    *,
    ...
    default_repos = (
        "/data/Dataset/Reasoning2Action-Sim/dataset_without_depth/pour_workpiece:"
    ...
    repo_paths = [p for p in os.environ.get("FIVE_TASK_REPO_PATHS", default_repos).split(":") if p]
